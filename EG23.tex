...
explicit distinction. One dedicated to cooling, with a residence time of 84
...
The specified cooling time is supposed to be 60 month and a year each for
reprocessing and fabrication. 84 month of cooling time have been implemented
because both separation and fabrication requires any buffer time. However, a
...
reactor. In those Cyclus simulations, the  out of reactor minimum time is 87 months.
...
tHM/year$) that it will not limits the reprocessing. The used FBR-MOX fuel will
