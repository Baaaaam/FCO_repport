...
\begin{table}[h!]
    ...
    \begin{tabularx}{350pt}{lXXX}
      ...
      \hline
      \hline
      Assembly size [kgHM]  &  29565           &  1393.33          &  1563.64          \\
      Assembly in the core  &  3               &  27               &  22               \\
      Assembly per batches  &  1               &  5                &  5                \\
      Cycle length, [month] &  18               &  12               &  12               \\
      Core Inventory, [tHM] &  3$\times$29.565 &  27$\times$1.393  &  22$\times$1.564  \\
      \hline
    \end{tabularx}
...
For this calculation, all of the reprocessing facilities are based onV only
...
\ref{fig:storage}. After 2100, with the decommissioning of the LWRs and the
