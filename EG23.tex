...
fuel cycle simulator DYMON (ANL) \cite{dymon}, VISION (INL) \cite{vision}, 
and ORION (ORNL) \cite{orion}. The goal was to illustrated the capabilities of the 
Cyclus simulator \cite{cyclus}, an agent based fuel cycle simulator developed at University of 
Wisconsin-Madison. \\
